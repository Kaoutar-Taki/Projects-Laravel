                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-32 w-32" src="/darklogo.png" alt="logo">
                        </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        <div class="flex-shrink-0">
                            <img class="h-10 w-10 rounded-full" src="/profile.png" alt="">
                        </div>
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">Kaoutar Taki</div>
                            <div class="text-sm font-medium leading-none text-gray-400">kaoutar@taki.com</div>
                        </div>
                        <button type="button"
